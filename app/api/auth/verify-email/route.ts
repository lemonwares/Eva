  ...
  <div class="email-container">
    ...
    <div class="body">
      ...
      <div class="support-section">
        💡 <strong>Need help getting started?</strong> Check out our <a href="${helpUrl}">Help Center</a> or reach out to our support team at support@eva.com
      </div>
      <div class="divider"></div>
      <div class="content-text">
    ...
    <div class="footer">
      ...
      <div class="footer-text">📧 support@eva.com | 🌐 eva.com</div>
    </div>
  </div>
</body>
</html>`;
