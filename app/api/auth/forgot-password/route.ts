  ...
  <div class="email-container">
    ...
    <div class="body">
      ...
      <div class="security-box">
        🛡️ <strong>Security Notice:</strong> If you didn't request a password reset, please ignore this email immediately. Your password will remain unchanged and your account is secure. If you believe your account is compromised, contact us at support@eva.com
      </div>
    ...
    <div class="footer">
      ...
      <div class="footer-text">📧 support@eva.com</div>
    </div>
  </div>
</body>
</html>`;
