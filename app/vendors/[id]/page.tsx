...
import { ScheduleDisplay, WeeklySchedule } from "@/components/vendors/profile/ScheduleDisplay";
import { VendorGallery } from "@/components/vendors/profile/VendorGallery";
import { VendorListings, Listing } from "@/components/vendors/profile/VendorListings";
import { VendorReviewsSection, Review } from "@/components/vendors/profile/VendorReviewsSection";
import { VendorTeamMembers } from "@/components/vendors/profile/VendorTeamMembers";

const SingleVendorMap = dynamic(
  () => import("@/components/vendors/SingleVendorMap"),
  {
    ssr: false,
    loading: () => (
      <div className="flex items-center justify-center h-[350px] w-full bg-muted/30 rounded-2xl border border-border">
...
export default function VendorDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero / Gallery */}
      <VendorGallery images={images} businessName={vendor.businessName} />
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1">
            ...
            {(vendor.cultureTraditionTags?.length || 0) > 0 && (
              <div className="mb-12">
                ...
                <VendorListings
                  ...
                  handleMultiListingBooking={handleMultiListingBooking}
            ...
            <VendorReviewsSection 
              reviews={reviews} 
              reviewCount={vendor._count?.reviews || 0} 
              businessName={vendor.businessName} 
            />

            {/* Team members */}
            <VendorTeamMembers teamMembers={teamMembers} />
            ...
            {vendor.description && (
              <div className="mb-12">
                ...
                <div
                  ...
                  style={{ height: "350px", position: "relative", zIndex: 0 }}
                >
                  {vendor.geoLat && vendor.geoLng ? (
                    <SingleVendorMap
                      lat={vendor.geoLat}
                        ...
                        <div className="mt-3 space-y-2">
                          {compatibility.allCompatible ? (
                            ...
                            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-3">
                              ...
                              {(compatibility.totalIncompatiblePrice || 0) > 0 && (
                                <p className="text-xs text-amber-600 dark:text-amber-400 mt-2">
                                  Removing incompatible services will reduce total by {formatCurrency(compatibility.totalIncompatiblePrice || 0)}
                                </p>
                              )}
                            </div>
                          )}
