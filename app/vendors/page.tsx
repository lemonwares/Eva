...
function VendorsPageContent() {
  ...
  const searchProviders = useCallback(
    async (pageNumber: number) => {
      ...
      try {
        ...
        params.set("published", "true"); // Only show published vendors
  ...
  useEffect(() => {
    ...
    if (filters.ceremony) params.set("ceremony", filters.ceremony);

    const newUrl = params.toString() ? `/vendors?${params}` : "/vendors";
